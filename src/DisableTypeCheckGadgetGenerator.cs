//Based on https://github.com/med0x2e/GadgetToJScript/blob/master/GadgetToJScript/_DisableTypeCheckGadgetGenerator.cs
...
namespace GadgetToJScript
{
	...
	public class TextFormattingRunPropertiesMarshal : ISerializable
	{
		...
		public void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.SetType(t);
			info.AddValue("ForegroundBrush", xaml);
		}
	...
	class DisableTypeCheckGadgetGenerator
	{
		public MemoryStream generateGadget(MemoryStream ms)
		{
			...
			Object tfrpm = new TextFormattingRunPropertiesMarshal(payload);
			BinaryFormatter bf = new BinaryFormatter();
			ms = new MemoryStream();
			bf.Serialize(ms, tfrpm);
			return ms;
		}
	}
}
